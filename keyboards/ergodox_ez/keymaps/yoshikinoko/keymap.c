...
[NUMB] = LAYOUT_ergodox(
       ...
       KC_JYEN,KC_EXLM,KC_AT,  KC_HASH,KC_DLR, KC_PERC,KC_TRNS,
...
[SYMB] = LAYOUT_ergodox(
       KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS,
       KC_SLCK, KC_TILD, KC_LT,   KC_GT,   KC_QUES, KC_PIPE, KC_TRNS,
       KC_NLCK, KC_GRV,  KC_COMM, KC_DOT,  KC_SLSH, KC_BSLS,
       KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS,
       KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS,
                                           KC_TRNS, KC_TRNS,
                                                    KC_TRNS,
    ...
    // right hand
       KC_TRNS,  KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS,
       KC_TRNS,  KC_UNDS, KC_PLUS, KC_LCBR, KC_RCBR, KC_COLN, KC_DQT,
 ...
 *                                 `--------------------'       `--------------------'
 */
// Shift bottom key to home position
[SBTM] = LAYOUT_ergodox(
       KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS,
       KC_PSCR, KC_ZKHK, KC_RO,   KC_KANA, KC_HENK, KC_MHEN, KC_TRNS,
       KC_INS,  KC_Z,    KC_X,    KC_C,    KC_V,    KC_B,
       KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS,
...
const uint16_t PROGMEM fn_actions[] = {
    [1] = ACTION_LAYER_TAP_TOGGLE(NUMB),                // FN1 - Momentary Layer 1 (NUMBols),
    [2] = ACTION_LAYER_TAP_TOGGLE(SYMB),                // FN1 - Momentary Layer 1 (Symbols),
    [3] = ACTION_LAYER_TAP_TOGGLE(SBTM),                // FN1 - Momentary Layer 1 (Symbols),
};
